...
<template>
  <section class="grid gap-4 overflow-hidden pb-8">
    <div class="carbon-card rounded-xl p-5">
      <p class="mb-2 text-xs font-black uppercase tracking-[0.2em] text-[var(--drixal-blue)]">{{ t("companyAdmin.eyebrow") }}</p>
      <div class="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          <h1 class="text-2xl font-semibold leading-8 tracking-tight">{{ t("companyAdmin.title") }}</h1>
